...
class SubmitCommentUseCase @Inject constructor(
    ...
    suspend operator fun invoke(postId: String, commentText: String): Result<Unit, NetworkError> {
        ...
        return homeRepository.submitComment(commentId, postId, commentText, user, userType)
    }
}